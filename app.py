...
if __name__ == "__main__":
    ...
    st.sidebar.markdown('[![Title](https://www.chi.sg/images/Logos/Healthcare/nhgroup.svg)](‘https://corp.nhg.com.sg/Pages/default.aspx’)')
    st.sidebar.markdown('[![Title](https://www.chi.sg/images/Logos/Healthcare/singhealth.svg)](‘https://www.singhealth.com.sg’)')
