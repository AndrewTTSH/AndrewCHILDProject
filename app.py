...
if __name__ == "__main__":
    ...
    st.sidebar.markdown('[![Title](https://www.chi.sg/images/Logos/Healthcare/nuhsgroup.svg)](‘https://corp.nhg.com.sg/Pages/default.aspx’)')
    st.sidebar.markdown('[![Title](https://www.chi.sg/images/Logos/Healthcare/nuhsgroup.svg)](‘https://www.singhealth.com.sg’)')
    st.sidebar.markdown('[![Title](https://www.chi.sg/images/Logos/Healthcare/nuhsgroup.svg)](‘https://www.nuhs.edu.sg/Pages/Home.aspx’)')
